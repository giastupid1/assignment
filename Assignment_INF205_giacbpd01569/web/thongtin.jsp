...
<td><input type="text" name="hoten" value="<%=model.thongtin.hoten%>"/></td>
</tr>
<tr>
<td height="45" style="text-align:right;">Số điện thoại:</td>
<td><input type="number" name="sodt" value="<%=model.thongtin.sodt%>"/></td>
</tr>
<tr>
<td height="45" style="text-align:right;">Số CMND:</td>
<td><input type="number" name="socmnd" value="<%=model.thongtin.socmnd%>"/></td>
</tr>
<tr>
<td height="45" style="text-align:right;">Địa chỉ:</td>
<td><input type="text" name="diachi" value="<%=model.thongtin.diachi%>"/></td>
</tr>
<tr>
<td height="45" style="text-align:right;">Email:</td>
<td><input type="text" name="email" value="<%=model.thongtin.email%>"/></td>
</tr>
